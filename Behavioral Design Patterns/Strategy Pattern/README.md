...
- **Result**: The [PaymentService.java](./GoodCode/PaymentService.java) (Context) remains unchanged when new payment methods are added. Strategies are swapped at runtime in [Main.java](./GoodCode/Main.java).

## How to Run
- `BadCode/BadPaymentProcessor.java` (Logic is hardcoded and rigid)
- `GoodCode/Main.java` (Logic is flexible and swappable)
